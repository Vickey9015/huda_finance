...
class Releaser_model extends CI_Model {
    public $error       = array();
   ...
   function getreleaserlList($startDate='',$toDate=''){
		...
		$where = "(a.annexure_status='3' ".$condtion.")";
        $this->db->where($where);
...
//         FROM ".TBL_ANNEXURE_TEMP."  a WHERE a.annexure_status='3'
