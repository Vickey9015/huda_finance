...
class Orginal_model extends CI_Model {

	var $table = 'annexure_temp';
	var $column_order =array('file_name','zone_name','customer_reference_number','serial_no','sector_no','villlage_name','section_notfn_date','is_petition_filed','award_no','award_date','LAO_bank_account_no','beneficiary_name','khewat_no','share_in_ownership','acre','kanal','marla','beneficiary_PAN','gross_amount_to_paid','TDS_deducted','net_amount','ifsc_code','account_number','is_EDC','mobile_number','authorised_on','released_on','returned_on','rejected_on','is_return','is_resubmitted','reason'); //set column field database for datatable orderable
