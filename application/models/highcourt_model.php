...
class HighCourt_model extends CI_Model {

	var $table = 'annexure_temp';
	var $column_order =array('file_name','zone_name','customer_reference_number','serial_no','sector_no','villlage_name','LAO_bank_account_no','award_no','award_date','ADJ_court_order_no','ADJ_court_decision_date','high_court_order_no','high_court_decision_date','beneficiary_name','khewat_no','share_in_ownership','acre','kanal','marla','beneficiary_PAN','  gross_amount_to_paid','TDS_deducted','net_amount','ifsc_code','account_number','is_EDC','mobile_number','authorised_on','released_on','returned_on','rejected_on','is_return','is_resubmitted','reason'); //set column field database for datatable orderable
