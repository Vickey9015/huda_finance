...
<div class="col-md-12 inner_white mt-4">
  ...
  <nav class="mt-4 mb-3">
    <div class="nav nav-tabs" id="nav-tab" role="tablist">
      ...
      <a class="nav-item nav-link active" id="nav-profile-tab" href="<?php echo base_url() ?>AnnexureReport/LowerCourtReport" role="tab" aria-controls="nav-profile" aria-selected="false">Lower Court (
    ...
    <div class="card-body" style="padding: 0.75rem">
      <?php foreach($this->session->userdata('zones_option') as $zone){ 
                ...
                // echo $file_link= base_url()."report/Original/OA_".date('Y-m-d')."_".$zone_id.".xlsx"; 
                 $filename = "report/LowerCourt/LC_".date('Y-m-d')."_".$zone_id.".xlsx";
                  $file_link= base_url()."report/LowerCourt/LC_".date('Y-m-d')."_".$zone_id.".xlsx"; 
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    table = $('#example').DataTable({
      ...
      "ajax": {
        "url": "<?php echo base_url() ?>AjaxReport/LowerCourtReportByAjax",
        "type": "POST",
...
<script>
   $(document).prop('title', 'LowerCourtReport');
</script>
</body>
</html>