  ...
  <!-- BEGIN CONTENT -->
    ...
    <nav style="margin-bottom: 8px;">
      <div class="nav nav-tabs" id="nav-tab" role="tablist">
        ...
        <a class="nav-item nav-link active" id="nav-contact-tab"  href="<?php echo base_url() ?>report/HCDDReport" role="tab" aria-controls="nav-contact" aria-selected="false">HC DD (<?php echo htmlspecialchars($totalcount[0]['highcourt_dd']); ?>)</a>
      </div>
    </nav>
			<form id="link_pay_forms" method="POST" enctype="multipart/form-data" action="<?php echo base_url() ?>report/HCDDReport">
			    <?php echo form_open();
