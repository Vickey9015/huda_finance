...
<style>
 #email-error, #mobile-error, #CaptchaInput-error {
    color:red;
    }  
.forget_password{
     color: red;
...
?>
	<!-- BEGIN LOGIN FORM -->
	<form class="form-horizontal m-t-20" id="forgotpassform" action="<?php echo base_url(); ?>user/forgotPasswordOtp" method="post" autocomplete="off" >
                        <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
                        <div class="form-group">
                            <div class="col-xs-12">
                               <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Mobile" name="mobile" id="mobile">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">
...
<script type="text/javascript">
    ...
    return false;
        ...
        $("#forgotpassform").validate({
            ...
            messages: {
                    mobile:{ 
                        required : "Please enter Registered Mobile !",
                        remote: "Phone number does not exists."
                    },
                    CaptchaInput:{
