...
<?php endif; ?>
          <div class="pink_bar"> <h4>In Process For Disbursement</h4> <h4>Total Amount: &#x20B9; <span id="totalAmount"></span></h4><div class="col-md-6 ml-auto pink_right"> 
...
<div class="table-responsive" id="table_data">
  ...
  Annexure type
      ...
      <th scope="col">In process For Disbursement</th>
	  ...
	  <input type="hidden" id="current_status" name="current_status" value="9">
      </div>
							<?php 
$totalAmount = 0;
...
foreach($result as $key=>$item){
	if($item["in_process_to_disbursement"] != 0){
...
$path      =base_url(). '/upload/'.$annexure_file[$item["annexure_type"]].'/'.$item["file_name"];
                                   ...
                                   $totalAmount            +=$item["in_process_to_disbursement_sum"];
                                   ?>
  <tr>
  <?php if ($role_id == 5 or $role_id == 9) {?>
     <td scope="row"> 
...
<td><a href="<?php echo base_url() ?>innerList/InnerMandateList/<?php echo $ref_no;?>/<?php echo $type;?>/9"><?php echo  htmlspecialchars($item["in_process_to_disbursement"]); ?></a> <br> &#x20B9; <span class="netAmount"><?php  if($item["in_process_to_disbursement_sum"] > 0){
...
<?php if ($role_id == 5 or $role_id == 9) {?>
<button type="button"  ng-click="confirmRelease($event,'reject','file')" class="btn upload_button mr-4" name="action" value="reject" disabled="true" style="background-color:#353535;margin-left: 35%;" id="rejBtn">Reject</button>
<!--<button type="button"  ng-click="confirmRelease($event,'release','file')" class="btn upload_button">
  Release
</button>-->
<?php } ?>
</form>
