...
.custom-dropdown::after {
  ...
  <!-- BEGIN CONTENT -->
	<div class="col-md-12 inner_white mt-4">
        <div class="row">
          <div class="pink_bar"> <h4>Annexures</h4> <h4>Total Amount: <span id="totalAmount"></span></h4><div class="col-md-6 ml-auto pink_right"> 
    ...
    <nav style="margin-bottom: 8px;">
      <div class="nav nav-tabs" id="nav-tab" role="tablist">
        ...
        <a class="nav-item nav-link" id="nav-contact-tab"  href="<?php echo base_url() ?>report/DDReport" role="tab" aria-controls="nav-contact" aria-selected="false">SC DD (<?php echo $totalcount[0]['dd']; ?>)</a>
        <a class="nav-item nav-link active" id="nav-contact-tab"  href="<?php echo base_url() ?>report/OriginalDDReport" role="tab" aria-controls="nav-contact" aria-selected="false">Original DD (<?php echo htmlspecialchars($totalcount[0]['original_dd']); ?>)</a>
        ...
        <a class="nav-item nav-link" id="nav-contact-tab"  href="<?php echo base_url() ?>report/HCDDReport" role="tab" aria-controls="nav-contact" aria-selected="false">HC DD (<?php echo $totalcount[0]['highcourt_dd']; ?>)</a>
      </div>
    </nav>
			<form id="link_pay_forms" method="POST" enctype="multipart/form-data" action="<?php echo base_url() ?>report/OriginalDDReport">
			    <?php echo form_open();
            ...
            <div class="col-md-2 zerorightpadding" style="margin-right: 8%;text-align:center;
">
              ...
              <div class="col-md-2 zerorightpadding" style="margin-right: 8%;
text-align: center;">
                                            <div class="form-group">
                                                <label>To Upload Date</label>
<div class="form-group input-group lod">
                                                    <span class="input-group-addon">
                                                        <i class="fa fa-calendar pr-2"></i>
                                                    </span>
