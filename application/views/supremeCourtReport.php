...
.custom-dropdown::after {
 ...
 <a class="nav-item nav-link active" id="nav-contact-tab"  href="<?php echo base_url() ?>report/SupremeCourtReport" role="tab" aria-controls="nav-contact" aria-selected="false">Supreme Court (<?php echo htmlspecialchars($totalcount[0]['suprem_court']); ?>)</a>
