...
.custom-dropdown::after {
  ...
  <div class="nav nav-tabs" id="nav-tab" role="tablist">
    ...
    <a class="nav-item nav-link active" id="nav-contact-tab"  href="<?php echo base_url() ?>report/HighCourtReport" role="tab" aria-controls="nav-contact" aria-selected="false">High Court (<?php echo htmlspecialchars($totalcount[0]['high_court']); ?>)</a>
 ...
 <a class="nav-item nav-link " id="nav-contact-tab"  href="<?php echo base_url() ?>report/DDReport" role="tab" aria-controls="nav-contact" aria-selected="false">SC DD (<?php echo htmlspecialchars($totalcount[0]['dd']); ?>)</a>
  <a class="nav-item nav-link" id="nav-contact-tab"  href="<?php echo base_url() ?>report/OriginalDDReport" role="tab" aria-controls="nav-contact" aria-selected="false">Original DD (<?php echo htmlspecialchars($totalcount[0]['original_dd']); ?>)</a>
        ...
        <a class="nav-item nav-link" id="nav-contact-tab"  href="<?php echo base_url() ?>report/HCDDReport" role="tab" aria-controls="nav-contact" aria-selected="false">HC DD (<?php echo htmlspecialchars($totalcount[0]['highcourt_dd']); ?>)</a>
			...
			<form id="link_pay_forms" method="POST" enctype="multipart/form-data" action="<?php echo base_url() ?>report/HighCourtReport">
			    <?php echo form_open();
...
<th scope="col">Date of Decision by ADJ Court (DD-MM-YY)
</th>
<th scope="col">High Court Order No.</th>
<th scope="col">Date of Decision by High Court (DD-MM-YY)
</th>
            ...
            <td><?php  echo htmlspecialchars($item["khewat_no"]);  ?></td>
             ...
             <td><?php  echo htmlspecialchars($item["marla"]);  ?></td>
						 ...
						 <td><?php  if($item["annexure_status"] == 6){
                              echo $item["is_return"] == 1 ? "Returned" : "Returned (Failed)";
                            }else {
...
<?php $gAmount                 =moneyFormatIndia(htmlspecialchars($grossAmount));
$tAmount                 =moneyFormatIndia(htmlspecialchars($tdsAmount));
$nAmount                 =moneyFormatIndia(htmlspecialchars($netAmount));
$totalCnt                =moneyFormatIndia(htmlspecialchars($totalCount));
//echo $amount; exit;
?>
<script>
