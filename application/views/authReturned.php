...
?>
          <div class="pink_bar"> <h4>Returned List</h4> <h4>Total Amount: &#x20B9; <span id="totalAmount"></span></h4><div class="col-md-6 ml-auto pink_right"> 

</div>  </div>
        </div>
		 <form id="link_pay_forms" method="POST" enctype="multipart/form-data" action="<?php echo base_url() ?>authorizerReturned/authReturnedList">
		     <?php echo form_open();
            ...
            <div class="col-md-3 zerorightpadding" >
                  ...
                  <div class="form-group input-group loc">
                       ...
                       <input class="form-control input-sm datepickersettle" id="fromDate" NAME="fromDate" placeholder="From Date" style="height:40px;" value="<?php echo htmlspecialchars(date('d-m-Y')); ?>">
                                                </div>
                                            </div>
                                        </div>
              <div class="col-md-3 zerorightpadding" >
