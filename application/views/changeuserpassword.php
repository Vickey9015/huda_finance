...
<div class="col-md-12 inner_white mt-4">
  ...
  <div class="row mandates">
    <div class="table-responsive" id="table_data">
      <form action="<?php echo base_url() ?>member/changepassword/<?php echo $userId ?>" class="form-horizontal form-row-seperated"  method="POST" id="changeuserPwdForm">
        <?php echo form_open();
        ...
        <div class="form-body">
          ...
          <div class="form-group">
            ...
            <div class="col-md-9">
            <!--   <input type="hidden" value="<?php //echo !empty($userId)? $userId :'' ?>" name="id"> -->
