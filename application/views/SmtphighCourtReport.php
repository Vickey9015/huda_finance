...
.custom-dropdown::after {
  ...
  <div class="nav nav-tabs" id="nav-tab" role="tablist">
    ...
    <a class="nav-item nav-link active" id="nav-contact-tab"  href="<?php echo base_url() ?>smtpReport/SMTPHighCourtReport" role="tab" aria-controls="nav-contact" aria-selected="false">High Court (<?php echo htmlspecialchars($totalcount[0]['high_court']); ?>)</a>
