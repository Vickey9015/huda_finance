  ...
  <span class="checkmark"></span>
            ...
            <td><?php echo  htmlspecialchars($item["created_on"]);  ?>  </td>
				...
				echo '0';
												...
												<td><a href="<?php echo base_url() ?>innerList/InnerMandateList/<?php echo $ref_no;?>/<?php echo $type;?>/7"><?php  echo $item["released"];  ?></a><br> &#x20B9; <?php  if($item["released_sum"] > 0){
