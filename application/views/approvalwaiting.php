...
$path      =base_url(). '/upload/'.$annexure_file[$item["annexure_type"]].'/'.$item["file_name"];
  ...
  <?php if($role_id == 4){ ?>
   ...
   <input type="checkbox" class="checkbox1" name="reference_number[]" id="color" value="<?php echo htmlspecialchars($item["reference_number"]);?>">
  <span class="checkmark"></span>
</label>
      </td>
      <?php } ?>
      <td><!--<a href="<?php echo base_url() ?>innerList/InnerMandateList/<?php echo $ref_no;?>/<?php echo $type;?>">--><?php echo  $item["maker_name"]; ?><!--</a>--></td>
      <td><a href="complexDownload" download="<?php echo  htmlspecialchars($item["file_name"]); ?>" onclick="this.href='<?php echo htmlspecialchars($path); ?>';"><?php echo  htmlspecialchars($item["file_name"]); ?></a></td>
...
<td><a href="<?php echo base_url() ?>innerList/InnerMandateList/<?php echo htmlspecialchars($ref_no);?>/<?php echo htmlspecialchars($type);?>/2"><?php echo  htmlspecialchars($item["with_checker"]); ?></a> <br> &#x20B9; <span class="netAmount"><?php  if($item["with_checker_sum"] > 0){
...
<?php if($role_id == 4){ ?>
<button type="button"  ng-click="confirmRelease($event,'reject','file','auth')" value="reject" class="btn upload_button mr-4" style="background-color:#353535;margin-left: 35%;">Reject</button>
<button type="button"  ng-click="confirmRelease($event,'authorization','file','auth')" value="rsubmit" class="btn upload_button">
  Submit to releaser
</button>
<?php } ?>
</form>
