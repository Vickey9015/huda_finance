...
.custom-dropdown::after {
 ...
 <a class="nav-item nav-link active" id="nav-contact-tab"  href="<?php echo base_url() ?>report/DDReport" role="tab" aria-controls="nav-contact" aria-selected="false">SC DD (<?php echo htmlspecialchars($totalcount[0]['dd']); ?>)</a>
