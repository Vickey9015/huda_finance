...
<div class="col-md-12 inner_white mt-4 dash_x pink_bar">
  ...
  <div class="modal fade" id="addMyModal" role="dialog">
    <div class="modal-dialog">
      <div class="modal-content" id="mainCont">
        ...
        <div class="modal-body">
          ...
          <div id="valTitle" style="display: none;" class="alert alert-danger">
            <small><strong>Warning!</strong> Duplicate Records</small>
          </div>
          ...
          <div class="form-group" id="valCheck" style="padding-left: 15px; display: none;">
            ...
            <label class="col-form-label "> <small> Please confirm to proceed</small></label>
          </div>
      ...
      <div class="modal-content" id="verifyCont" style="display:none;">
...
<script>
  ...
  function doSomething() {
    ...
    table = $('#example1').DataTable({
      ...
      "ajax": {
        ...
        "url": "<?php echo base_url('rejectedrecords/GetUpdatedRecordList') ?>",
        "type": "POST",
        data: {
  ...
  $("#btnSaveIt").click(function(){
    ...
    if(allowData == 'on'){
      ...
      $("#valMsg").show();
      $("#valMsg").html('Please check the box to continue');
    }
  });
