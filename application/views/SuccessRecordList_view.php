  ...
  <div class="col-md-12 alignCenterPhone">
        ...
        <div class="card-body" style="padding: 0.75rem">
          <?php foreach($this->session->userdata('zones_option') as $zone){ 
                    ...
                    $filename = "report/Unclaimed/Success/UnclaimedPayment_".date('Y-m-d')."_".$zone_id.".xlsx";
                    $file_link= base_url()."report/Unclaimed/Success/UnclaimedPayment_".date('Y-m-d')."_".$zone_id.".xlsx"; 
  ...
  function doSomething() {
    ...
    table = $('#example1').DataTable({
      ...
      "ajax": {
        ...
        "url": "<?php echo base_url('SuccessRecords/GetUpdatedRecordList') ?>",
        "type": "POST",
        data: {
