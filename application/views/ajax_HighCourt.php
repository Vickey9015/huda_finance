...
<div class="col-md-12 inner_white mt-4">
  ...
  <nav class="mt-4 mb-3">
    <div class="nav nav-tabs" id="nav-tab" role="tablist">
      ...
      <a class="nav-item nav-link active" id="nav-contact-tab"  href="<?php echo base_url() ?>AnnexureReport/HighCourtReport" role="tab" aria-controls="nav-contact" aria-selected="false">High Court (
    ...
    <div class="card-body" style="padding: 0.75rem">
      <?php foreach($this->session->userdata('zones_option') as $zone){ 
                ...
                // echo $file_link= base_url()."report/Original/OA_".date('Y-m-d')."_".$zone_id.".xlsx"; 
                 $filename = "report/HighCourt/HC_".date('Y-m-d')."_".$zone_id.".xlsx";
                  $file_link= base_url()."report/HighCourt/HC_".date('Y-m-d')."_".$zone_id.".xlsx"; 
  ...
  $(document).ready(function() {
    ...
    table = $('#example').DataTable({
     "aLengthMenu": [[100,200,500,1000], [100,200,500,1000]],
      ...
      "ajax": {
        "url": "<?php echo base_url() ?>AjaxReport/HighCourtReportByAjax",
        "type": "POST",
...
<script>
   $(document).prop('title', 'HighCourtReport');
</script>
</body>
</html>