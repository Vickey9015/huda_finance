...
.custom-dropdown::after {
  ...
  <div class="nav nav-tabs" id="nav-tab" role="tablist">
    <a class="nav-item nav-link active" id="nav-home-tab" href="<?php echo base_url() ?>smtpReport/SMTPOriginalReport" role="tab" aria-controls="nav-home" aria-selected="true">Original (<?php echo htmlspecialchars($totalcount[0]['original']); ?>)</a>
...
<th scope="col">Customer Reference Number
</th>
  </tr>
  </thead>
		<tbody>
