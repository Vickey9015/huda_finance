        ...
        <div class="modal-body">
          ...
          <form role="form" id="newModalForm">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input type="text" class="form-control" id="reAccNo" name="reAccNo" autocomplete="off" require />
              </div>
            </div>
            <div class="form-group">
...
<script>
  ...
  function doSomething() {
    ...
    table = $('#example1').DataTable({
      ...
      "ajax": {
        ...
        "url": "<?php echo base_url('FileApprove/fetchData') ?>",
        "type": "POST",
        data: {
          ref_no: ref_no,
          // fromDate: fromDate,
    ...
    $("#newModalForm").validate({
      ...
      submitHandler: function(form) {
        ...
        $.ajax({
          ...
          type: 'POST',
          data: {recordId: recordId, beneName:beneName,accNo:accNo, reAccNo:reAccNo, ifscCode:ifscCode, amount:amount},
  ...
  function updateData(){
    ...
    $.ajax({
    url: "<?php echo base_url('FileApprove/updateData') ?>",
    type: 'POST',
