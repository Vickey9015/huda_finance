...
<!--		<form id="link_pay_forms" method="POST" enctype="multipart/form-data" action="<?php //echo base_url() ?>member/memberView">-->
   ...
   <table class="table bg-white t_data" cellspacing="0" width="100%" id="example">
        ...
        <tbody>
          ...
          <tr>
					    ...
					    <td><?php echo htmlspecialchars($item['is_view']) == 1 ? 'View Access' : htmlspecialchars($item["role_name"]); ?></td>
...
<a href="<?php echo base_url() ?>member/updateStatus/<?php echo $item["id"];?>/<?php echo $item["is_active"];?>" class="btn btn-success a-btn-slide-text" style="background-color: #b53363;">
...
<a href="<?php echo base_url() ?>member/updateStatus/<?php echo $item["id"];?>/<?php echo $item["is_active"];?>" class="btn btn-success a-btn-slide-text" style="background-color: #b53363;">
    ...
    <td><a href="<?php echo base_url() ?>member/updateMember/<?php echo $item["id"];?>" class="btn btn-success a-btn-slide-text" style="background-color: #b53363;">
        <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
						<i class="fa fa-edit"></i> Edit </a> </td> 
	<td><a href="<?php echo base_url() ?>member/deleteMember/<?php echo $item["id"];?>/4" class="btn btn-success a-btn-slide-text" style="background-color: #b53363;">
        <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
