...
<div class="table-responsive" id="table_data">
   <table class="table bg-white t_data" cellspacing="0" width="100%" id="example">
        ...
        <tbody>
					...
					if($item['checker_id']==0 || $item['checker_id']!=0){
                                   ?>
          <tr>
					  ...
					  <td><?php echo htmlspecialchars($item['is_view']) == 1 ? 'View Access' : htmlspecialchars($item["role_name"]); ?></td>
						...
						?></td>
						<td><?php if($item['checker_id'] == 0)echo "Pending Verification";
						          elseif($item['checker_id'] != 0)echo "Verified";
						?></td>
                        <td><?php echo htmlspecialchars($item["created_on"]); ?></td>
						<td><?php echo htmlspecialchars($item["updated_on"]); ?></td>
    <td><?php if($item['checker_id'] == 0){ ?>
<a href="<?php echo base_url() ?>member/verifyMember/<?php echo $item["id"];?>/3" class="btn btn-success a-btn-slide-text" style="background-color: #b53363;">
        <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
						<i class="fa fa-inactive"></i> Verify </a>
						<?php }?>
						<?php if($item['checker_id']!= 0){ ?>
<a href="#" class="btn btn-success a-btn-slide-text" style="background-color: #b53363;">
        <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
						<i class="fa fa-active"></i> Verified </a>
						<?php }?>
						</td>
                       </tr>
                        <?php
