  ...
  <!-- BEGIN CONTENT -->
    ...
    <nav style="margin-bottom: 8px;">
      <div class="nav nav-tabs" id="nav-tab" role="tablist">
        ...
        <a class="nav-item nav-link active" id="nav-contact-tab"  href="<?php echo base_url() ?>report/LCDDReport" role="tab" aria-controls="nav-contact" aria-selected="false">LC DD (<?php echo htmlspecialchars($totalcount[0]['lowercourt_dd']); ?>)</a>
        <a class="nav-item nav-link" id="nav-contact-tab"  href="<?php echo base_url() ?>report/HCDDReport" role="tab" aria-controls="nav-contact" aria-selected="false">HC DD (<?php echo htmlspecialchars($totalcount[0]['highcourt_dd']); ?>)</a>
			...
			<form id="link_pay_forms" method="POST" enctype="multipart/form-data" action="<?php echo base_url() ?>report/LCDDReport">
			    <?php echo form_open();
