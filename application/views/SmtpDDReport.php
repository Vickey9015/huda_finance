...
.custom-dropdown::after {
  ...
  <!-- BEGIN CONTENT -->
	<div class="col-md-12 inner_white mt-4">
        <div class="row">
          <div class="pink_bar"> <h4>Annexures</h4> <h4> <span id=""></span></h4><div class="col-md-6 ml-auto pink_right"> 
 ...
 <a class="nav-item nav-link" id="nav-contact-tab"  href="<?php echo base_url() ?>smtpReport/SMTPSupremeCourtReport" role="tab" aria-controls="nav-contact" aria-selected="false">Supreme Court (<?php echo htmlspecialchars($totalcount[0]['suprem_court']); ?>)</a>
 <a class="nav-item nav-link active" id="nav-contact-tab"  href="<?php echo base_url() ?>smtpReport/SMTPDDReport" role="tab" aria-controls="nav-contact" aria-selected="false">DD Report (<?php echo htmlspecialchars($totalcount[0]['dd']); ?>)</a>
  </div>
</nav>
			<!--<form id="link_pay_forms" method="POST" enctype="multipart/form-data" action="<?php echo base_url() ?>report/DDReport">
                                     <div class="row formpanelrow smalltablerow">
            <div class="col-md-3 zerorightpadding" style="margin-right: 8%;text-align:center;
">
...
<div class="form-group input-group lod">
      ...
      <select class="form-control input-sm" id="annexure_status" name="annexure_status" style="height:40px;">
                                  <option value="2" <?php if ($_REQUEST['annexure_status'] == '2') { echo 'selected'; } ?>>Pending at LAO &nbsp;</option>
...
<th scope="col">Customer Reference Number</th>
			...
			<th scope="col">Gross Amt. to be Paid</th>
			...
			<th scope="col">Specifically mention EDC OR NON EDC</th>
			<th scope="col">Transaction Type</th>
			<th scope="col">Drawee Location
</th>
			<th scope="col">Print Location
</th>
			<th scope="col">drawee Name
</th>
                        <th scope="col">Value date
</th>
