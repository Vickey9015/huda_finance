...
<td><a href="complexDownload" download="<?php echo  $item["file_name"]; ?>" onclick="this.href='<?php echo $path; ?>';"><?php echo  htmlspecialchars($item["file_name"]); ?></a></td>
            ...
            <td><?php echo htmlspecialchars(date('d M Y',strtotime($item['returned_on'])));  ?>  </td>
				...
				echo '0';
												...
												<td><a href="<?php echo base_url() ?>innerList/InnerReturnedList/<?php echo $ref_no;?>/<?php echo $type;?>"><?php  echo htmlspecialchars($item["returned"]);  ?></a><br> &#x20B9; <?php  if($item["returned_sum"] > 0){
				echo moneyFormatIndia($item["returned_sum"]);
				}else{
				echo '0';
				}   ?></td>   												
