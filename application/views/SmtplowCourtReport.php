...
.custom-dropdown::after {
  ...
  <div class="nav nav-tabs" id="nav-tab" role="tablist">
    ...
    <a class="nav-item nav-link active" id="nav-profile-tab" href="<?php echo base_url() ?>smtpReport/SMTPLowCourtReport" role="tab" aria-controls="nav-profile" aria-selected="false">Lower Court (<?php echo htmlspecialchars($totalcount[0]['lower_court']); ?>)</a>
