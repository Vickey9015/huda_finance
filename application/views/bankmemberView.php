...
?>
          <div class="pink_bar"> <h4>Member Listing</h4> <div class="col-md-6 ml-auto pink_right"> 
</div>
		  </div>
        </div>
   ...
   <table class="table bg-white t_data" cellspacing="0" width="100%" id="example">
        ...
        <tbody>
          ...
          <tr>
						...
						<td><?php echo htmlspecialchars($item['zone_name']);
						?></td>
						<td><?php if($item['is_active']==1)echo "Active";
						          elseif($item['is_active']==0)echo "Inactive";
						?></td>
                        <td><?php echo htmlspecialchars($item["created_on"]); ?></td>
						<td><?php echo htmlspecialchars($item["updated_on"]); ?></td>
						<td><?php if($item['is_active']==1){ ?>
<a href="<?php echo base_url() ?>admin/updateStatus/<?php echo $item["id"];?>/<?php echo $item["is_active"];?>" class="btn btn-success a-btn-slide-text" style="background-color: #b53363;">
        <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
						<i class="fa fa-inactive"></i> Inactive </a>
						<?php }?>
						<?php if($item['is_active']==0){ ?>
<a href="<?php echo base_url() ?>admin/updateStatus/<?php echo htmlspecialchars($item["id"]);?>/<?php echo $item["is_active"];?>" class="btn btn-success a-btn-slide-text" style="background-color: #b53363;">
        <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
						<i class="fa fa-active"></i> Active </a>
						<?php }?>
						</td>
    <td><a href="<?php echo base_url() ?>admin/updateBankMember/<?php echo htmlspecialchars($item["id"]);?>" class="btn btn-success a-btn-slide-text" style="background-color: #b53363;">
        <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
						<i class="fa fa-edit"></i> Edit </a> </td>
	                   <td><a href="<?php echo base_url() ?>admin/deleteMember/<?php echo htmlspecialchars($item["id"]);?>" class="btn btn-success a-btn-slide-text" style="background-color: #b53363;">
