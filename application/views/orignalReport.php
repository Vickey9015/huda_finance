...
.custom-dropdown::after {
  ...
  <div class="nav nav-tabs" id="nav-tab" role="tablist">
    <a class="nav-item nav-link active" id="nav-home-tab" href="<?php echo base_url() ?>report/OriginalReport" role="tab" aria-controls="nav-home" aria-selected="true">Original (<?php echo htmlspecialchars($totalcount[0]['original']); ?>)</a>
    <a class="nav-item nav-link" id="nav-profile-tab" href="<?php echo base_url() ?>report/LowCourtReport" role="tab" aria-controls="nav-profile" aria-selected="false">Lower Court (<?php echo htmlspecialchars($totalcount[0]['lower_court']); ?>)</a>
...
<form id="link_pay_forms" method="POST" enctype="multipart/form-data" action="<?php echo base_url() ?>report/OriginalReport">
                <?php echo form_open();
...
">
                                            <div class="form-group">
                                                <label class="text-left"><b>From Date</b></label>
                  <div class="form-group input-group loc">
                                                    <span class="input-group-addon">
                                                        <i class="fa fa-calendar"></i>
                                                    </span>
                       <input class="form-control input-sm datepickersettle" id="fromDate" NAME="fromDate" placeholder="From Date" style="height:40px;" value="<?php echo set_value('fromDate') ?>">
                                                </div>
                                            </div>
                                        </div>
              <div class="col-md-2 zerorightpadding" style="text-align: center;">
                                            <div class="form-group">
                                                <label class="text-left"><b>To Date</b></label>
<div class="form-group input-group loc">
                                                    <span class="input-group-addon">
                                                        <i class="fa fa-calendar"></i>
                                                    </span>
                <input NAME="toDate" id="toDate" class="form-control input-sm datepickersettle" placeholder="To Date" style="height:40px;" value="<?php echo set_value('toDate') ?>">
                                                </div>
                                            </div>
                                        </div>
										<div class="col-md-2" >
                                            <div class="form-group">
                                                <label class="text-left"><b>Annexure Status</b></label>
...
<option value="12" <?php if ($_REQUEST['annexure_status'] == '12') { echo 'selected'; } ?>>Failed &nbsp;</option>
...
<th scope="col">Date of Section 6 Notification (DD-MM-YY)
</th>
<th scope="col">Whether petition filed by the land owner for release of land 
</th>
<th scope="col">Award No.</th>
<th scope="col">Date of Award (DD-MM-YY)
</th>
<th scope="col">Bank A/c No. of LAO from which payment is to be made
</th>
...
<th scope="col">Net Amount to be paid to Beneficiary
</th>
<th scope="col">IFSC code of Beneficiary
</th>
<th scope="col">Bank A/c of the Beneficiary</th>
<th scope="col">EDC OR Non EDC [E= EDC, N = Non EDC]
</th>
<th scope="col">10- Digit Mobile Number
</th>
...
$(window).load(function ()
{
	...
	var annexure_status   ="<?php echo $questionArr['annexure_status'] ?>";
	$("#classID option[value="+annexure_status+"]").attr("selected", "selected");
