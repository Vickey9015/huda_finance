...
<div class="col-md-12 inner_white mt-4">
  ...
  <nav class="mt-4 mb-3">
    <div class="nav nav-tabs" id="nav-tab" role="tablist">
      ...
      <a class="nav-item nav-link active" id="nav-contact-tab"  href="<?php echo base_url() ?>AnnexureReport/DDReport" role="tab" aria-controls="nav-contact" aria-selected="false">SC DD (
    ...
    <div class="card-body" style="padding: 0.75rem">
      <?php foreach($this->session->userdata('zones_option') as $zone){ 
                ...
                // echo $file_link= base_url()."report/Original/OA_".date('Y-m-d')."_".$zone_id.".xlsx"; 
                 $filename = "report/DD/SCDD_".date('Y-m-d')."_".$zone_id.".xlsx";
                  $file_link= base_url()."report/DD/SCDD_".date('Y-m-d')."_".$zone_id.".xlsx"; 
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    table = $('#example').DataTable({
      ...
      "ajax": {
        "url": "<?php echo base_url() ?>AjaxReport/DDReportByAjax",
        "type": "POST",
...
<script>
   $(document).prop('title', 'SCDDReport');
</script>
</body>
</html>